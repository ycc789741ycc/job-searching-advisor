...
Procrastinate's job tables are applied. Any failure raises and exits non-zero,
so a failed migration fails the start rather than letting the app serve on a
...
from app import apply_job_schema
