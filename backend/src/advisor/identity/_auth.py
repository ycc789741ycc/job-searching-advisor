...
Google exchange (``advisor.identity._google``) proves who someone is, and
...
from advisor.identity._infra.auth_repository import AuthRepository, digest
from advisor.identity._infra.models import (
    Account,
    AiUsageBudget,
    FederatedIdentity,
    PasswordCredential,
...
from advisor.identity._infra.passwords import (
    dummy_verify,
    hash_password,
    needs_rehash,
    verify_password,
